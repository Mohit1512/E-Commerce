...
<title>Car Store | Buy car and show your class</title>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
     <img height="47px" width="110px" class="img-rounded"style="padding-top:1px;border-round:2px;" src="<c:url value="/resources/images/l.jpg" />" />
